...
<!-- Fonts -->
<link href="{{ asset('/assets/admin/fonts/Inter-Regular.woff2') }}" rel="preload" as="font" type="font/woff2" crossorigin>
<link href="{{ asset('/assets/admin/fonts/Inter-Medium.woff2') }}" rel="preload" as="font" type="font/woff2" crossorigin>
